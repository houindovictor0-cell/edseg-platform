    ...
    if (!$admin) {
        ...
        $actualites = [
            ...
            [
                ...
                'contenu'          => "L'EDSEG organise en partenariat avec l'Université de Paris 1 Panthéon-Sorbonne un colloque international sur le thème « Économie numérique, entrepreneuriat et développement durable en Afrique subsaharienne » les 12 et 13 juin 2026 à Cotonou.\n\nLes propositions de communications sont attendues avant le 1er mai 2026. Les meilleurs articles seront publiés dans une revue scientifique indexée partenaire de l'EDSEG.",
            ...
            [
                ...
                'contenu'          => "L'École Doctorale des Sciences Économiques et de Gestion a signé le 5 avril 2026 une convention de partenariat avec l'Université Laval au Québec. Cet accord ouvre la voie à des programmes de cotutelle permettant aux doctorants de l'EDSEG d'obtenir un diplôme reconnu conjointement par les deux institutions.\n\nCinq places sont disponibles pour la première cohorte 2026–2027. Les candidats intéressés sont invités à se rapprocher du bureau de la coopération internationale de l'EDSEG.",
            ...
            [
                'titre'            => 'Publication — Trois enseignants-chercheurs de l\'EDSEG dans une revue SCOPUS',
                'contenu'          => "Les professeurs Jean Kouassi, Marie-Claire Adjovi et Rodrigue Hounkpatin de l'EDSEG ont co-signé un article scientifique intitulé « Inclusion financière et réduction de la pauvreté au Bénin : une analyse par les données de panel » publié dans la revue African Development Review, indexée SCOPUS.\n\nCette publication témoigne du dynamisme de la recherche au sein de l'EDSEG et de sa visibilité croissante sur la scène académique internationale.",
                'image'            => 'https://images.unsplash.com/photo-1532094349884-543559b8f5a0?w=800&q=80',
                'categorie'        => 'actualite',
                'publiee'          => true,
