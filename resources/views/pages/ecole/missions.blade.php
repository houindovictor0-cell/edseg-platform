...
<section class="max-w-screen-xl mx-auto px-8 py-20">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        <div class="space-y-12">
            <div>
                <p class="text-[10px] font-semibold tracking-widests uppercase text-[#C9962B] mb-4">Notre raison d'être</p>
            ...
            <div class="space-y-8">
                ...
                <div class="border-l-2 border-[#003366] pl-8">
                    <h3 class="garamond text-2xl font-medium text-[#003366] mb-3">{{ $titre }}</h3>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-[#F5F7FA] p-10">
                <p class="text-[10px] font-semibold tracking-widest uppercase text-[#C9962B] mb-6">Objectifs stratégiques</p>
                <ul class="space-y-4">
                    @foreach([
                    ...
                    <li class="flex gap-4 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 bg-[#C9962B] rounded-full mt-2 flex-shrink-0"></span>
                        {{ $obj }}
                    </li>
                    @endforeach
                </ul>
